...
import com.aryancodes.apnidukaan.databinding.FragmentCustomerProfileBinding
...
class CustomerProfileFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val customerProfileViewModel =
            ViewModelProvider(this).get(CustomerProfileViewModel::class.java)

        _binding = FragmentCustomerProfileBinding.inflate(inflater, container, false)
        val root: View = binding.root

        val textView: TextView = binding.textNotifications
        customerProfileViewModel.text.observe(viewLifecycleOwner) {
            textView.text = it
        }
        return root
    }
